(function (exports, Laya) {
            ...
            if (this.isRender) {
                ...
                for (var j = 0, m = this._shaderInstances.length; j < m; j++) {
                    ...
                    if (this.renderShaderData) {
                        var uploadSprite3D = (shaderIns._uploadRender !== this.renderShaderData) || switchUpdateMark;
    ...
    class WebGLDirectLightShadowRP {
        ...
        set light(value) {
            this._light = value;
            var lightWorld = Laya.Matrix4x4.TEMPMatrix0;
        ...
        update(context) {
            ...
            var forward = Laya.Vector3._tempVector3;
        ...
        initRenderpass(camera, context) {
            ...
            if (enableShadow) {
                ...
                if (needDirectionShadow) {
                    ...
                    let directionShadowMap = Laya.ILaya3D.Scene3D._shadowCasterPass.getDirectLightShadowMap(mainDirectionLight);
                ...
                if (needSpotShadow) {
                    ...
                    let spotShadowMap = Laya.ILaya3D.Scene3D._shadowCasterPass.getSpotLightShadowPassData(mainSpotLight);
                ...
                camera.scene._shaderValues.setVector(Laya.ShadowCasterPass.SHADOW_PARAMS, this.renderpass.shadowParams);
            }
    ...
    class WebGLSkinRenderElement3D extends WebGLRenderElement3D {
        ...
        drawGeometry(shaderIns) {
            ...
            for (var j = 0, m = this.geometry.drawParams.length / 2; j < m; j++) {
                ...
                shaderIns.uploadCustomUniform(Laya.SkinnedMeshSprite3D.BONES, subSkinnedDatas);
                var offset = j * 2;
